...
export default function SachaNote({ sutra, dateKey }: Props) {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto px-4 sm:px-0">
      ...
      {!open ? (
        ...
        <div className="border-t border-[#d5d2cf] pt-8 pb-10">
          {/* 헤더 */}
          ...
          {/* 원문 참고 */}
          <p className="text-[13px] text-[#aaa] leading-relaxed whitespace-pre-line mb-6 border-l-2 border-[#d5d2cf] pl-4">
            {sutra}
          </p>
          ...
          {done ? (
            ...
            <>
              <textarea
                ...
                rows={4}
                className="w-full bg-transparent border border-[#d5d2cf] focus:border-[#1a1a1a] outline-none px-4 py-3 text-[14px] text-[#1a1a1a] leading-relaxed resize-none transition-colors placeholder:text-[#ccc]"
              />
              {/* 진행률 */}
