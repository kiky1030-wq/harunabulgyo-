...
export const metadata: Metadata = {
  title: "Meditation Timer — LotusRead",
  description: "After reading today's scripture, close your eyes and meditate. Choose from 1 to 20 minutes with a gentle bell at the end.",
};
    ...
    <div className="min-h-screen bg-[#EEECEA] text-[#1a1a1a] flex flex-col">
      <nav className="px-4 sm:px-8 py-5 sm:py-6 flex items-center justify-between flex-shrink-0">
        ...
        <div className="flex items-center gap-4">
          <Link href="/timer" className="text-[12px] text-[#1a1a1a] tracking-[0.04em] border border-[#1a1a1a] px-2 py-0.5 hover:bg-[#1a1a1a] hover:text-[#EEECEA] transition-colors">KO</Link>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-16">
        <p className="text-[12px] tracking-[0.2em] uppercase text-[#555] mb-12">Meditation Timer</p>
        <MeditationTimer lang="en" />
      </main>
